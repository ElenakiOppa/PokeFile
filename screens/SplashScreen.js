  ...
  return (
    <SafeAreaView style={styles.screen} edges={['top', 'bottom']}>
      ...
      <View style={styles.footer}>
        <ActivityIndicator color={GOLD} size="small" style={styles.loader} />
...
const styles = StyleSheet.create({
  ...
  glow: {
    ...
    backgroundColor: 'rgba(212,175,55,0.08)', shadowColor: GOLD,
    shadowOpacity: 0.24, shadowRadius: 36, shadowOffset: { width: 0, height: 0 },
  },
  mark: {
  ...
  markRing: { width: 24, height: 24, borderRadius: 12, borderWidth: 4, borderColor: '#080808', backgroundColor: GOLD },
  wordmark: { alignItems: 'center', gap: 8 },
  name: { color: '#f4f4f5', fontFamily: 'Manrope_700Bold', fontSize: 36, lineHeight: 44, letterSpacing: -0.8 },
  tagline: { color: GOLD, fontFamily: 'Manrope_400Regular', fontSize: 11, lineHeight: 16, letterSpacing: 0.45 },
